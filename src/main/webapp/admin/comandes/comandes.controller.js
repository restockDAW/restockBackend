app.controller("comandesCtrl", function($scope, $http, $window, Notification, comandesService, botiguesService, proveidorsService, productesService, inventariService, Auth) {
    ...
    function LoadComandes() {
        //add loader
        return comandesService.getAllComandes(Auth.currentUser().organitzacio)
            .then(function (data) {
                console.log(data);
                $scope.comandes = data;
    ...
    function LoadProductes() {
        //add loader
        return productesService.getProductesOfProveedor($scope.comanda.proveidor)
            .then(function (data) {
                console.log(data);
